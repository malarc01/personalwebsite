function init() {
	...
	function nextSlide(pageNumber) {
		...
		const nextReft = nextPage.querySelector('.hero .model-right');
	...
	const timelineOne = new TimelineMax({ pause: true });
	...
	timelineOne
		...
		.from(hamburgerLines, 0.2, { stroke: 'white' }, { stroke: 'black' }, '-=1');

	hamburger.addEventListener('click', () => {
		timelineOne.reversed() ? timelineOne.play() : timelineOne.reverse();
	});
}
